export LD_LIBRARY_PATH=${LD_LIBRARY_PATH}:/home/crm/miniconda3/envs/pbhc/lib/
...
python humanoidverse/urci.py \
    ...
    +checkpoint=logs/MotionTracking/phuma_student/exported/model_15000.onnx \
    ++robot.asset.xml_file=g1/g1_23dof_lock_wrist_rev_2.xml \
    ++robot.motion.motion_file=motion_data/g1_ue_walk_23dof.pkl 