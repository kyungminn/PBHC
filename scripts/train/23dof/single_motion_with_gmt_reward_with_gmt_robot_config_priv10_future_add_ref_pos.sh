...
python humanoidverse/train_agent.py \
    ...
    +obs=motion_tracking/main_priv_with_future_add_ref_pos \
    +robot=g1/g1_23dof_general \
    +domain_rand=main \
    +rewards=motion_tracking/general_main \
    experiment_name=g1_walk_45cms_with_gmt_reward_with_gmt_robot_config_priv10_future_add_ref_pos \
    ...
    algo.config.module_dict.actor.motion_encoder.input_dim=[57] \
    algo.config.module_dict.actor.motion_encoder.hidden_dim=114 \
