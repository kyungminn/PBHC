...
python humanoidverse/train_agent.py \
    ...
    +obs=motion_tracking/main_priv_with_future_lin_vel_in_actor \
    +robot=g1/g1_23dof_general \
    +domain_rand=main \
    +rewards=motion_tracking/general_main \
    experiment_name=g1_walk_45cms_with_gmt_reward_with_gmt_robot_config_priv10_future_add_linvel \
