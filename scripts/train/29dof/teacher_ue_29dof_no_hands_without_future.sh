...
python humanoidverse/train_agent.py \
    +simulator=isaacgym +exp=general_tracking_no_future +terrain=terrain_locomotion_plane \
    project_name=MotionTracking num_envs=4096 \
    +obs=motion_tracking/obs_ppo_teacher_no_hands_no_future \
    +robot=g1/g1_29dof_general_no_vr \
    +domain_rand=main \
    +rewards=motion_tracking/general_main \
    experiment_name=kungfubot2_teacher_walk_45cms_29dof_no_hands_without_future \
