...
python humanoidverse/train_agent.py \
    ...
    +obs=motion_tracking/main_no_vr \
    +robot=g1/g1_29dof_single_motion_no_vr \
    +domain_rand=main \
    +rewards=motion_tracking/main \
    experiment_name=kungfubot1_walk_45cms_29dof_no_vr_higher_arch \
    ...
    rewards.reward_scales.teleop_vr_3point=0 \
    algo=mh_ppo_higher_arch