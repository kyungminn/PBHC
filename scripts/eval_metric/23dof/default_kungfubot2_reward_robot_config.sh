...
python humanoidverse/eval_metrics.py \
    ...
    +checkpoint=/home/kyungminlee/PBHC/logs/MotionTracking/20260131_064711-g1_walk_45cms_with_gmt_reward_with_gmt_robot_config-motion_tracking-g1_23dof_lock_wrist/model_20000.pt \
    ++metrics_save_path=./ablation_results/default_kungfubot2_reward_robot_config.txt
