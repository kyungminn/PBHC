...
python humanoidverse/eval_metrics.py \
    ...
    +checkpoint=/home/kyungminlee/PBHC/logs/MotionTracking/20260131_063904-g1_walk_45cms_with_gmt_reward_add_keybodies-motion_tracking-g1_23dof_lock_wrist/model_20000.pt \
    ++metrics_save_path=./ablation_results/default_gmt_reward.txt
