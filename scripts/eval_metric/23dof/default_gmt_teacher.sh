...
python humanoidverse/eval_metrics.py \
    ...
    +checkpoint=/home/kyungminlee/PBHC/logs/MotionTracking/20260201_092937-g1_walk_45cms_gmt_teacher-motion_tracking-g1_23dof_lock_wrist/model_20000.pt \
    ++metrics_save_path=./ablation_results/gmt_teacher.txt
